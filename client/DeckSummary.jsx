            ...
            <div className='deck-summary col-xs-12'>
                ...
                <div className='decklist'>
                    ...
                    <div className='col-xs-8 col-sm-6'>
                        ...
                        <div className='info-row row' ref='deckFormat'><span>Format:</span><span className='pull-right'>{ this.props.deck.format ? this.props.deck.format.name : 'Stronghold' }</span></div>
