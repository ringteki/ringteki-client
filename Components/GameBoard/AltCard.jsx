    ...
    render() {
        ...
        if(this.props.card.icons) {
            for(let [icon, present] of Object.entries(this.props.card.icons)) {
                if(present) {
                    icons.push(<div className={ `challenge-icon ringsicon ringsicon-${icon} with-background` } />);
                } else {
        ...
        return (
            <div className='card-alt'>
                <div className='card-top-row'>
                    ...
                    { ['attachment', 'event'].includes(this.props.card.type) && <div className={ `card-faction attachment ringsicon ringsicon-${this.props.card.faction} with-background` } /> }
                </div>
                ...
                <div className={ classNames('card-name-row', { 'vertical': this.props.card.type === 'location' }) }>
                    ...
                    { ['character', 'location', 'plot'].includes(this.props.card.type) && <div className={ `card-faction ringsicon ringsicon-${this.props.card.faction} with-background` } /> }
                </div>
